...
dropdown_options = [
    {'label': 'Yearly Statistis', 'value': 'Yearly Statistics'},
...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard",style={'textAlign':'center','color':'#503D36', 'font-size':24}), #Inclue Style for Title
...
@app.callback(
    ...
    [Input(component_id='dropdown-statistics', component_property='value'), 
     Input(component_id='select-year', component_property='year')])
  ...
  # Plot bar chart for average number of vehicles sold during the given year
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data,
            ...
            names = 'Vehicle_Type',
            title = 'Total Advertisment Expenditure for each Vehicle Type in the year {}'.format())
        )
